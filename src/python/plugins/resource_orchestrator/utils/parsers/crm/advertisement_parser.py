...
import os, sys
lib_path = '/opt/felix/ocf/expedient/src/python/plugins/resource_orchestrator/utils/'
sys.path.append(lib_path)
from sfa.util import xrn
from parsers.parser_base import ParserBase
from parsers.commons_com import Node, Link
from parsers.commons import DEFAULT_XMLNS
