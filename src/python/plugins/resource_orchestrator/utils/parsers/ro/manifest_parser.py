...
from parsers.crm.manifest_parser import CRMv3ManifestParser
from parsers.openflow.manifest_parser import OFv3ManifestParser
from parsers.serm.manifest_parser import SERMv3ManifestParser
from parsers.tnrm.manifest_parser import TNRMv3ManifestParser

#import core
#logger = core.log.getLogger("utility-rspec")

import logging
logger = logging.getLogger("utility-rspec")
